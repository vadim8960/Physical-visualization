...
QT_MOC_LITERAL(1, 13, 10), // "stop_timer"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16), // "setStatusPainter"
QT_MOC_LITERAL(4, 42, 6) // "status"

    },
    "OpenglWidget\0stop_timer\0\0setStatusPainter\0"
    "status"
};
...
void OpenglWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stop_timer(); break;
        case 1: _t->setStatusPainter((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenglWidget::stop_timer)) {
                *result = 0;
                return;
            }
        }
