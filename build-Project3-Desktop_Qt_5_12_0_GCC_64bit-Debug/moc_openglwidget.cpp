...
#include "../Project3/openglwidget.h"
...
QT_MOC_LITERAL(1, 13, 11), // "startChange"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16), // "changeParameters"
QT_MOC_LITERAL(4, 43, 16), // "setStatusPainter"
QT_MOC_LITERAL(5, 60, 6) // "status"

    },
    "OpenglWidget\0startChange\0\0changeParameters\0"
    "setStatusPainter\0status"
};
...
void OpenglWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->startChange(); break;
        case 1: _t->changeParameters(); break;
        case 2: _t->setStatusPainter((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenglWidget::startChange)) {
                *result = 0;
                return;
            }
        }
